...
### Definition of Done
- [ ] 44.1/16 and 96/24 FLAC play with correct pitch and no distortion in exclusive mode.
- [ ] DAC indicator matches track sample rate in exclusive mode.
...
### Final Checklist
- [ ] Exclusive playback is clean for 44.1/16 and 96/24 on iFi Zen DAC.
- [ ] DAC indicator matches track sample rate in exclusive mode.
